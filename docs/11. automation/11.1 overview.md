...
These capabilities should build on the current automation definitions, execution state, run-history, trigger, and event foundations.
...
The current in-memory implementations provide the foundation for future persistent storage, background workers, advanced event routing, and broader automation orchestration.
